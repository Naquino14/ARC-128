...
// ARC Mix Columns Lookup Table

namespace ARC
{
    internal class ARCMCLT
    {
        /// how this works:
        /// f(x) = outgoing[x]
        internal static readonly byte[] LTv1 = new byte[] // for some reason this wont let me make it constant
        {
        ...
        internal static (string msg, byte[] table) GenerateLookup()
        {
            var output = "";
